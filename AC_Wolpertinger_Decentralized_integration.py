...
cache_sizes = [5 + i*5 for i in range(3)]
...
number_of_clients = [5 + i*5 for i in range(3)]
...
number_of_videos = [i*20 for i in range(1,6)]
...
zipf_parameters = [i*0.4 for i in range(4)]
